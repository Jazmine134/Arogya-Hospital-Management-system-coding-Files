...
<body>
    ...
    include('./navbar.php');
    ?>
<h2>Search patient Invoice records</h2>
<form method="GET" action="invoicesearch.php">
    <p>
...
$sql = "SELECT * FROM invoices WHERE invoice_id like '%$search%' or patient_id like '%$search%'";
